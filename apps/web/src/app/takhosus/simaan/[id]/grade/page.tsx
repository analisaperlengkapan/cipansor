...
export default function GradeSimaanPage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    if (exam && !exam.overallScore) { // Only auto-calc if not manually overridden or first load
        ...
        <div className="md:col-span-1 space-y-6">
            <Card>
                ...
                <CardContent className="space-y-4">
                    ...
                    <DetailItem label="Juz" value={`${exam.juzStart} - ${exam.juzEnd}`} />
                    <DetailItem label="Tanggal" value={new Date(exam.examDate).toLocaleDateString('id-ID')} />
                </CardContent>
            </Card>
        </div>
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <FormField
                            ...
                            render={({ field }) => (
                            <FormItem>
                                <FormLabel className="text-lg font-semibold">Nilai Akhir (Rata-rata)</FormLabel>
                                <FormControl>
                                <Input type="number" min={0} max={100} {...field} className="text-lg font-bold" />
                                </FormControl>
                                <FormDescription>Dihitung otomatis atau input manual</FormDescription>
                                <FormMessage />
                            </FormItem>
                            )}
                        />
                    ...
                    <FormField
                        ...
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                            ...
                            <FormLabel className="text-base">Lulus Ujian?</FormLabel>
                            <FormDescription>
                    ...
                    <FormField
                        ...
                        <FormItem>
                            ...
                            <FormControl>
                            <Textarea placeholder="Rekomendasi tindak lanjut..." {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                        )}
