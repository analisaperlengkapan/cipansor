  ...
  return (
    <div className="relative">
      ...
      <div className={cn(
        ...
        level === 0 ? 'bg-gradient-to-r from-amber-50 to-amber-100/50 border-amber-300' :
        level === 1 ? 'bg-gradient-to-r from-blue-50 to-blue-100/50 border-blue-300 ml-8' :
        level === 2 ? 'bg-gradient-to-r from-green-50 to-green-100/50 border-green-300 ml-16' :
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <Badge variant="outline" className="text-xs font-arabic">{node.title}</Badge>
          </div>
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Silsilah ijazah dan sanad dari guru ke murid</CardDescription>
          </CardHeader>
          <CardContent>
