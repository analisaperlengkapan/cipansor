...
const STANDARDS = [
  {
    ...
    indicators: [
      {
        code: '1.1',
        name: 'Kurikulum Tingkat Satuan Pendidikan (KTSP) dikembangkan sesuai prosedur',
      },
  ...
  },
  {
    ...
    description:
      'Kriteria minimal tentang ruang belajar, tempat berolahraga, tempat beribadah, perpustakaan, laboratorium, bengkel kerja, tempat bermain, tempat berkreasi dan berekreasi, serta sumber belajar lain.',
    indicators: [
  ...
  },
  {
    ...
    description:
      'Perencanaan, pelaksanaan, dan pengawasan kegiatan pendidikan pada tingkat satuan pendidikan, kabupaten/kota, provinsi, atau nasional.',
    indicators: [
