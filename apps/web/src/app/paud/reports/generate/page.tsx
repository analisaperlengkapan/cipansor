...
import {
  useGeneratePAUDReport,
  useBulkGeneratePAUDReports,
...
export default function GeneratePAUDReportPage() {
  ...
  const generateMutation = useGeneratePAUDReport();
  const bulkGenerateMutation = useBulkGeneratePAUDReports();
