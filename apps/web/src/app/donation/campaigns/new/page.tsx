...
export default function NewCampaignPage() {
  ...
  const onSubmit = async (data: CampaignFormData) => {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : 'Gagal membuat campaign';
    ...
    <MainLayout>
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight">Buat Campaign Donasi</h1>
            <p className="text-muted-foreground">Buat campaign penggalangan dana baru</p>
          </div>
        </div>
            ...
            <CardContent>
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">Kosongkan untuk campaign yayasan</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">Minimal target Rp 100.000</p>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">Kosongkan jika tanpa batas waktu</p>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    {...register('imageUrl')}
                  />
                  <p className="text-sm text-muted-foreground">Gambar banner campaign (opsional)</p>
                ...
                <div className="flex gap-4 pt-4">
                  ...
                  <Button type="submit" disabled={isSubmitting || createCampaign.isPending}>
                    {isSubmitting || createCampaign.isPending ? 'Menyimpan...' : 'Buat Campaign'}
                  </Button>
                </div>
              </form>
            </CardContent>
