...
import { TKReportPeriod } from '@cipansor/shared';
...
export default function TKAssessmentListPage() {
  ...
  const { data, isLoading } = useTKAssessments({
    ...
    aspect: aspectFilter as TKAspect || undefined,
    achievementLevel: achievementFilter as TKAchievementLevel || undefined,
  ...
  const columns: ColumnDef<TKAssessment>[] = [
    {
