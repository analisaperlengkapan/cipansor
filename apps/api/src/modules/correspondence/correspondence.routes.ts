...
router.post('/dispositions', validate(createDispositionSchema), CorrespondenceController.createDisposition);
router.patch('/dispositions/:id/status', validate(updateDispositionStatusSchema), CorrespondenceController.updateDispositionStatus);
