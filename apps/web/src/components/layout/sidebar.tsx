...
import { getNavigationForRole, getNavigationForRoleCode, type NavGroup } from '@/config/navigation';
...
function NavGroupComponent({ group, pathname, collapsed, showSeparator }: NavGroupComponentProps) {
  return (
    <div className="mb-4">
