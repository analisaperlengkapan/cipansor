...
export interface ListAttendanceParams extends PaginationParams, DateRangeParams, UnitFilterParams {
    studentId?: string;
    classId?: string;
    status?: AttendanceStatus;
}
...
export const attendanceService = {
     ...
     */
    async list(params?: ListAttendanceParams): Promise<PaginatedResponse<AttendanceRecord>> {
        const response = await api.get<PaginatedResponse<AttendanceRecord>>('/attendance', {
            params
        });
    ...
    async create(input: CreateAttendanceInput): Promise<AttendanceRecord> {
        const response = await api.post<ApiResponse<AttendanceRecord>>('/attendance', input);
        return response.data.data;
    },
     ...
     */
    async update(id: string, input: Partial<CreateAttendanceInput>): Promise<AttendanceRecord> {
     ...
     */
    async getClassSummary(classId: string, date: string): Promise<ClassAttendanceSummary> {
