...
export function useReceptionStats() {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await api.get<{ data: ReceptionStats }>('/reception/stats');
...
export function useGuestBooks(params?: { date?: string }) {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await api.get<{ data: GuestBook[] }>('/reception/guests', { params });
      return response.data.data;
    }
  });
}
...
export function useCreateGuestBook() {
  ...
  return useMutation({
    mutationFn: async (data: CreateGuestBookInput) => {
      const response = await api.post<{ data: GuestBook }>('/reception/guests', data);
      return response.data.data;
    },
    onSuccess: () => {
...
export function useUpdateGuestBook() {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async ({ id, data }: { id: string; data: UpdateGuestBookInput }) => {
      const response = await api.patch<{ data: GuestBook }>(`/reception/guests/${id}`, data);
      return response.data.data;
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['reception', 'guests'] });
...
export function useStudentVisits(params?: { date?: string, studentId?: string }) {
  return useQuery({
    queryKey: ['reception', 'visits', params],
    queryFn: async () => {
      const response = await api.get<{ data: StudentVisit[] }>('/reception/visits', { params });
      return response.data.data;
    }
  });
}
...
export function useCreateStudentVisit() {
  ...
  return useMutation({
    mutationFn: async (data: CreateStudentVisitInput) => {
      const response = await api.post<{ data: StudentVisit }>('/reception/visits', data);
      return response.data.data;
    },
    onSuccess: () => {
...
export function useUpdateStudentVisit() {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async ({ id, data }: { id: string; data: UpdateStudentVisitInput }) => {
      const response = await api.patch<{ data: StudentVisit }>(`/reception/visits/${id}`, data);
      return response.data.data;
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['reception', 'visits'] });
...
export function useStudentPackages(params?: { status?: string, studentId?: string }) {
  return useQuery({
    queryKey: ['reception', 'packages', params],
    queryFn: async () => {
      const response = await api.get<{ data: StudentPackage[] }>('/reception/packages', { params });
      return response.data.data;
    }
  });
}
...
export function useCreatePackage() {
  ...
  return useMutation({
    mutationFn: async (data: CreateStudentPackageInput) => {
      const response = await api.post<{ data: StudentPackage }>('/reception/packages', data);
      return response.data.data;
    },
    onSuccess: () => {
...
export function useUpdatePackage() {
  ...
  return useMutation({
    mutationFn: async ({ id, data }: { id: string; data: UpdateStudentPackageInput }) => {
      const response = await api.patch<{ data: StudentPackage }>(`/reception/packages/${id}`, data);
      return response.data.data;
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['reception', 'packages'] });
