...
export default function TahfidzPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : 'Gagal menghapus catatan';
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Popover>
              <PopoverTrigger asChild>
                ...
                >
                  ...
                  {startDate ? format(startDate, 'd MMM yyyy', { locale: localeId }) : 'Dari Tanggal'}
                </Button>
              </PopoverTrigger>
            ...
            <Popover>
              <PopoverTrigger asChild>
                ...
                >
                  <CalendarIcon className="mr-2 h-4 w-4" />
                  {endDate ? format(endDate, 'd MMM yyyy', { locale: localeId }) : 'Sampai Tanggal'}
                </Button>
              </PopoverTrigger>
              <PopoverContent className="w-auto p-0">
                <Calendar
              ...
              {isLoading ? (
                ...
                <TableRow>
                  <TableCell colSpan={8} className="text-center py-8">
                    ...
                    <p className="text-muted-foreground">Tidak ada catatan tahfidz</p>
                  </TableCell>
                </TableRow>
              ) : (
                records.map((record) => (
