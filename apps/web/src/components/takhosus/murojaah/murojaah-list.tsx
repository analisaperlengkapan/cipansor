...
export function MurojaahList({
  ...
  const [editItem, setEditItem] = useState<
    import("@/hooks/use-murojaah").MurojaahRecord | null
  >(null);
  ...
  const getQualityBadge = (score: number) => {
    if (score >= 90)
      return <Badge className="bg-green-500">Mumtaz ({score})</Badge>;
    if (score >= 75)
      return <Badge className="bg-blue-500">Jayyid ({score})</Badge>;
    if (score >= 60)
      return <Badge className="bg-yellow-500">Maqbul ({score})</Badge>;
                  ...
                  <TableRow key={record.id}>
                    ...
                    <TableCell>
                      <Badge variant="outline">
                        {getTypeLabel(record.murojaahType)}
                      </Badge>
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      {getQualityBadge(record.qualityScore)}
                    </TableCell>
                    <TableCell>
