...
export default function ForecastPage() {
  ...
  const {
    ...
    isLoading,
    error,
  } = useQuery<{ success: boolean; data: AllForecasts }>({
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <p className="text-red-500">
          Error loading forecasts. Please try again.
        </p>
      </div>
    );
  }
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {data?.enrollment?.predictedValue || 0}
                </div>
                <div className="flex items-center gap-2 mt-1">
                  ...
                  {data?.enrollment && (
                    <TrendBadge
                      ...
                      percentage={data.enrollment.trendPercentage}
                    />
                  )}
                </div>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  {data?.payment && (
                    <TrendBadge
                      trend={data.payment.trend}
                      percentage={data.payment.trendPercentage}
                    />
                  )}
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  Collection Rate:{" "}
                  {data?.outstanding?.collectionRate?.toFixed(1) || 0}%
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  Current: {data?.tahfidz?.currentHafidz || 0} | Avg:{" "}
                  {data?.tahfidz?.averageCompletionRate || 0} ayah/bulan
                </p>
              </CardContent>
            </Card>
          </div>
            ...
            <TabsContent value="enrollment" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Data historis dan prediksi 6 bulan ke depan (area berwarna
                    lebih terang = prediksi)
                  </CardDescription>
                </CardHeader>
                <CardContent className="h-[400px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={data?.enrollment?.dataPoints || []}>
                      ...
                      <ReferenceLine
                        x={
                          data?.enrollment?.dataPoints?.find((d) => d.predicted)
                            ?.date
                        }
                        stroke="#666"
                        strokeDasharray="3 3"
            ...
            <TabsContent value="outstanding" className="space-y-4">
              <Card>
                ...
                <CardContent className="h-[400px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart
                      data={data?.outstanding?.dataPoints || []}
                      layout="vertical"
                    >
                      <CartesianGrid strokeDasharray="3 3" />
                      <XAxis
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-xl font-bold">
                      {formatCurrency(
                        data?.outstanding?.currentOutstanding || 0,
                      )}
                    </div>
                  </CardContent>
                </Card>
                <Card>
                  ...
                  <CardContent>
                    <div className="text-xl font-bold text-green-600">
                      {formatCurrency(
                        data?.outstanding?.predictedCollection || 0,
                      )}
                    </div>
                  </CardContent>
                </Card>
