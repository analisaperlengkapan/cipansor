...
export const authService = {
     ...
     */
    async updateProfile(input: Partial<Pick<UserProfile, 'name' | 'phone' | 'avatar'>>): Promise<UserProfile> {
        const response = await api.patch<ApiResponse<UserProfile>>('/auth/profile', input);
        return response.data.data;
    },
