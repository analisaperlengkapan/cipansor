...
interface AspectScore {
  ...
  level: PAUDAchievementLevel | null;
  label: string;
}

interface PAUDRadarChartProps {
  data: Record<PAUDAspect, {
...
const LEVEL_TO_SCORE: Record<PAUDAchievementLevel, number> = {
...
const LEVEL_COLORS: Record<PAUDAchievementLevel, string> = {
  BB: '#ef4444',  // red
