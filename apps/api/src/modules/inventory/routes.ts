...
router.get("/categories", authorize(UserRole.UNIT_ADMIN, UserRole.TEACHER, UserRole.STAFF), controller.getCategories);
router.post("/categories", authorize(UserRole.UNIT_ADMIN), controller.createCategory);
router.get("/categories/:id", authorize(UserRole.UNIT_ADMIN, UserRole.TEACHER, UserRole.STAFF), controller.getCategoryById);
