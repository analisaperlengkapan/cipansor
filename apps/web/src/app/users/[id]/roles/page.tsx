          ...
          <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[500px]">
              ...
              <div className="grid gap-4 py-4">
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent className="max-h-[300px]">
                      {Object.entries(availableRolesByRealm).map(
                        ([realm, roles]) => (
                ...
                {selectedRole &&
                  !["GLOBAL", "YAYASAN"].includes(selectedRole.realm) && (
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Assign to a specific unit or leave empty for realm-wide
                        access
                      </p>
                    </div>
                  )}
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <Badge
                        ...
                        className={cn(
                          "text-white",
                          realmColors[assignment.role.realm]?.split(" ")[0],
                        )}
                      >
                        {realmDisplayNames[assignment.role.realm] ||
                          assignment.role.realm}
                      </Badge>
                      <div>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                ...
                {deleteAssignment?.role.name}" from this user? This action
                cannot be undone.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
