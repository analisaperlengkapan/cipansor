...
const immunizationSchedules: ImmunizationSchedule[] = [
  ...
  },
  {
    ...
    ageMonthsMin: 2,
    ageMonthsMax: 2,
    description: 'Diberikan bersamaan dengan DPT-HB-Hib 1',
  },
  {
    vaccineName: 'Hepatitis B',
    vaccineCode: 'HB-2',
    ...
    ageMonthsMin: 3,
    ageMonthsMax: 3,
    description: 'Diberikan bersamaan dengan DPT-HB-Hib 2',
  },
  {
    vaccineName: 'Hepatitis B',
    vaccineCode: 'HB-3',
    ...
    ageMonthsMin: 4,
    ageMonthsMax: 4,
    description: 'Diberikan bersamaan dengan DPT-HB-Hib 3',
  },
  ...
  // BCG (Bacille Calmette-Guérin) - Tuberculosis
  {
    ...
    ageMonthsMin: 0,
    ageMonthsMax: 1,
    description: 'Diberikan pada usia 0-1 bulan',
  },
  ...
  // Polio
  {
    ...
    ageMonthsMin: 0,
    ageMonthsMax: 0,
    description: 'Diberikan saat lahir atau sebelum pulang dari RS',
  },
  {
    vaccineName: 'Polio (OPV)',
    vaccineCode: 'OPV-1',
  ...
  // DPT-HB-Hib (Pentavalent - Difteri, Pertusis, Tetanus, Hepatitis B, Haemophilus influenzae type b)
  {
    ...
    vaccineCode: 'DPT-HB-Hib-1',
    doseNumber: 1,
    ageMonthsMin: 2,
    ageMonthsMax: 2,
    description: 'Diberikan pada usia 2 bulan',
  },
  {
    vaccineName: 'DPT-HB-Hib',
    vaccineCode: 'DPT-HB-Hib-2',
    doseNumber: 2,
    ageMonthsMin: 3,
    ageMonthsMax: 3,
    description: 'Diberikan pada usia 3 bulan',
  },
  {
    vaccineName: 'DPT-HB-Hib',
    vaccineCode: 'DPT-HB-Hib-3',
    doseNumber: 3,
    ageMonthsMin: 4,
    ageMonthsMax: 4,
    description: 'Diberikan pada usia 4 bulan',
  },
  {
    vaccineName: 'DPT-HB-Hib (Booster)',
    vaccineCode: 'DPT-HB-Hib-B',
    doseNumber: 4,
    ageMonthsMin: 18,
    ageMonthsMax: 18,
    description: 'Booster diberikan pada usia 18 bulan',
  },
  ...
  // Campak / MR (Measles-Rubella)
  {
    ...
    ageMonthsMin: 9,
    ageMonthsMax: 9,
    description: 'Diberikan pada usia 9 bulan',
  },
  {
    vaccineName: 'Campak/MR',
    vaccineCode: 'MR-2',
    ...
    ageMonthsMin: 18,
    ageMonthsMax: 18,
    description: 'Diberikan pada usia 18 bulan',
  },
  ...
  },
  {
    ...
    ageMonthsMin: 6,
    ageMonthsMax: 6,
    description: 'Diberikan pada usia 6 bulan',
  },
  {
    ...
    ageMonthsMin: 12,
    ageMonthsMax: 15,
    description: 'Booster diberikan pada usia 12-15 bulan',
  },
  ...
  },
  {
    ...
    ageMonthsMin: 6,
    ageMonthsMax: 6,
    description: 'Diberikan pada usia 6 bulan (jika menggunakan Rotateq)',
  },
  ...
  // Influenza (yearly)
  {
    ...
    ageMonthsMin: 6,
    ageMonthsMax: 6,
    description: 'Diberikan pertama kali pada usia 6 bulan',
  },
  {
    vaccineName: 'Influenza',
    vaccineCode: 'FLU-2',
    ...
    ageMonthsMin: 7,
    ageMonthsMax: 7,
    description: 'Diberikan 1 bulan setelah dosis pertama',
  },
  {
    ...
    ageMonthsMin: 12,
    ageMonthsMax: 72,
    description: 'Diulang setiap tahun',
  },
  ...
  // JE (Japanese Encephalitis) - untuk daerah endemis
  {
    ...
    ageMonthsMin: 9,
    ageMonthsMax: 9,
    description: 'Diberikan pada usia 9 bulan (daerah endemis)',
  },
  {
    vaccineName: 'Japanese Encephalitis',
    vaccineCode: 'JE-2',
    ...
    ageMonthsMin: 21,
    ageMonthsMax: 24,
    description: 'Booster diberikan 12-24 bulan setelah dosis pertama',
  },
  ...
  // Varicella (Cacar Air)
  {
    ...
    ageMonthsMin: 12,
    ageMonthsMax: 18,
    description: 'Diberikan pada usia 12-18 bulan',
  },
  {
    vaccineName: 'Varicella',
    vaccineCode: 'VAR-2',
    ...
    ageMonthsMin: 48,
    ageMonthsMax: 72,
    description: 'Booster diberikan pada usia 4-6 tahun',
  },
  ...
  // Hepatitis A
  {
    ...
    ageMonthsMin: 12,
    ageMonthsMax: 24,
    description: 'Diberikan pada usia 12-24 bulan',
  },
  {
    vaccineName: 'Hepatitis A',
    vaccineCode: 'HA-2',
    ...
    ageMonthsMin: 18,
    ageMonthsMax: 36,
    description: 'Diberikan 6-12 bulan setelah dosis pertama',
  },
  ...
  // Typhoid
  {
    ...
    ageMonthsMin: 24,
    ageMonthsMax: 24,
    description: 'Diberikan mulai usia 2 tahun',
  },
  {
    vaccineName: 'Typhoid (Ulangan)',
    vaccineCode: 'TYP-R',
    doseNumber: 2,
    ageMonthsMin: 60,
    ageMonthsMax: 60,
  ...
  // HPV (untuk anak perempuan)
  {
    ...
    ageMonthsMin: 108,
    ageMonthsMax: 132,
    description: 'Diberikan pada usia 9-11 tahun',
  },
  {
    vaccineName: 'HPV',
    vaccineCode: 'HPV-2',
  ...
  // Td/Tdap (Tetanus, Diphtheria, acellular Pertussis) - School age
  {
    ...
    ageMonthsMin: 72,
    ageMonthsMax: 84,
    description: 'Diberikan pada kelas 1 SD (usia 6-7 tahun)',
  },
  {
    vaccineName: 'Td (Tetanus-difteri)',
    vaccineCode: 'Td-SD',
    doseNumber: 2,
    ageMonthsMin: 84,
    ageMonthsMax: 96,
    description: 'Diberikan pada kelas 2 SD (usia 7-8 tahun)',
  },
  {
    vaccineName: 'Td (Tetanus-difteri)',
    vaccineCode: 'Td-5',
    ...
    ageMonthsMin: 132,
    ageMonthsMax: 144,
    description: 'Diberikan pada kelas 5 SD (usia 11-12 tahun)',
  },
];
...
export function getUpcomingImmunizations(ageMonths: number): ImmunizationSchedule[] {
  return immunizationSchedules
    .filter((s) => s.ageMonthsMin > ageMonths && s.ageMonthsMin <= ageMonths + 6)
