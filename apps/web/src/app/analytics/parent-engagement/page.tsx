...
const mockEngagementData = {
  ...
  lowEngagement: [
    { parentName: 'Bapak Ahmad', childName: 'Muhammad Hasan', lastLogin: '14 hari lalu', reason: 'Tidak pernah login' },
    { parentName: 'Ibu Fatimah', childName: 'Aisyah Putri', lastLogin: '21 hari lalu', reason: 'Tidak respon pesan' },
    { parentName: 'Bapak Umar', childName: 'Ibrahim Malik', lastLogin: '30 hari lalu', reason: 'Belum bayar 3 bulan' },
  ],
};
      ...
      <div className="space-y-6">
          ...
          <Card className="bg-gradient-to-r from-primary/10 to-primary/5">
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm text-muted-foreground">Orang Tua Aktif</p>
                  <p className="text-2xl font-bold">{data.summary.activeParents}/{data.summary.totalParents}</p>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <p className="text-2xl font-bold">{data.summary.engagementRate}%</p>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm text-muted-foreground">Rata-rata Respon</p>
                  <p className="text-2xl font-bold">{data.summary.avgResponseTime} jam</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">{data.metrics.reportViews.value.toLocaleString()}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <Card key={key}>
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant={metric.change >= 0 ? 'default' : 'destructive'} className="h-6">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Login, lihat laporan, dan pesan per hari</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-[300px]">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={data.weeklyActivity}>
                    ...
                    <Bar dataKey="reports" name="Lihat Laporan" fill="#22c55e" />
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Persentase keterlibatan orang tua</CardDescription>
            </CardHeader>
              ...
              {data.classBreakdown.map((item) => (
                <div key={item.class} className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className={cn(
                      'font-bold',
                      item.engagement >= 85 ? 'text-green-600' :
                      item.engagement >= 75 ? 'text-amber-600' : 'text-red-600'
                    )}>
                      {item.engagement}%
                    </span>
                  </div>
        ...
        <Card className="border-amber-200 bg-amber-50/50">
          <CardHeader>
            ...
            <CardDescription>Orang tua dengan engagement rendah perlu di-follow up</CardDescription>
          </CardHeader>
          <CardContent>
