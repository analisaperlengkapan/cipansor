...
export async function createImmunizationRecord(
  data: import('./schema').CreateImmunizationRecordInput,
  recordedById: string
) {
...
export async function getImmunizationRecords(query: import('./schema').QueryImmunizationRecordInput) {
  const { page = 1, limit = 20, studentId, unitId, status } = query;
  const skip = (page - 1) * limit;
...
export async function updateImmunizationRecord(
  id: string,
  data: import('./schema').UpdateImmunizationRecordInput
) {
...
export async function deleteImmunizationRecord(id: string) {
