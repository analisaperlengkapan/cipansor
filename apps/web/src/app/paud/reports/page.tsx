...
export default function PAUDReportListPage() {
  ...
  const { data, isLoading } = usePAUDReports({
    page,
    limit: pageSize,
  ...
  const deleteMutation = useDeletePAUDReport();
  ...
  const columns: ColumnDef<PAUDNarrativeReport>[] = [
    {
      accessorKey: 'student',
      header: 'Siswa',
      cell: ({ row }) => (
