...
export const createImmunizationRecordSchema = z.object({
  ...
  administeredAt: z.string().optional(), // Place where it was given
  batchNumber: z.string().optional(),
  notes: z.string().optional(),
  status: z.enum(['PENDING', 'COMPLETED', 'SKIPPED']).default('PENDING'),
});

export const updateImmunizationRecordSchema = createImmunizationRecordSchema.partial().omit({ studentId: true, unitId: true });
