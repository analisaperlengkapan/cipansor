      ...
      <div className="space-y-6">
            ...
            <Card key={unit.unit} className="hover:shadow-md transition-shadow">
              ...
              <CardContent className="space-y-2">
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <Badge
                    variant={unit.kehadiran >= 90 ? "default" : "secondary"}
                  >
                    {unit.kehadiran}%
                  </Badge>
                </div>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Perbandingan total santri di setiap unit
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Perbandingan multi-aspek antar unit
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Perbandingan tingkat kehadiran 6 bulan terakhir
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Berdasarkan skor performa keseluruhan
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Perbandingan indikator utama antar unit
              </CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    {comparisonData.map((unit) => (
                      <tr key={unit.unit} className="border-b last:border-0">
                        ...
                        <td className="py-3 text-center">
                          <Badge
                            variant={
                              unit.kehadiran >= 90 ? "default" : "secondary"
                            }
                          >
                            {unit.kehadiran}%
                          </Badge>
                        ...
                        <td className="py-3 text-center">
                          <Badge
                            variant={
                              unit.tahfidz >= 85 ? "default" : "secondary"
                            }
                          >
                            {unit.tahfidz}%
                          </Badge>
