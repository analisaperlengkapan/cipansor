...
export function StudentCounselingTab({ studentId }: StudentCounselingTabProps) {
  const { data: counselingHistory, isLoading } =
    useStudentCounselingHistory(studentId);
    ...
    <Card>
      <CardHeader className="flex flex-row items-center justify-between">
        <div>
          ...
          <CardDescription>
            Record of counseling sessions and guidance
          </CardDescription>
        </div>
              ...
              <Table>
                ...
                <TableBody>
                  {counselingHistory.map((record) => {
                    ...
                    const statusConfig = getCounselingStatusConfig(
                      record.status,
                    );
                    return (
