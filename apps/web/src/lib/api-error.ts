...
const ERROR_MESSAGES: Record<number, { title: string; message: string }> = {
  400: {
    ...
    message: 'Data yang dikirim tidak sesuai format. Periksa kembali input Anda.',
  },
  401: {
    title: 'Sesi Berakhir',
...
const NETWORK_ERROR_CODES = ['ERR_NETWORK', 'ECONNREFUSED', 'ENOTFOUND', 'ETIMEDOUT'];
...
export function createMutationErrorHandler(
  options?: {
    ...
    showToast?: (title: string, message: string, type: 'error' | 'warning') => void;
  }
) {
